                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        <a class="menu-link" href="/">
                            ...
                            <span class="menu-link p-0">
                                ...
                                <span class="menu-title fw-600" style="color:#000">Dashboards</span>
...
<%--                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-2 py-4 w-200px mh-75 overflow-auto">--%>
                    ...
                    <div class="ms-4 mt-4">
                        <!--begin:Menu link-->
                      <a class="menu-link black" href="/api_references.aspx">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!--begin:Menu item-->
                    <div class="ms-4 mt-5">
                       <a class="menu-link black" href="/cov.aspx">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!--begin:Menu item-->
                    <div class="ms-4 mt-5">
                        <a class="menu-link black" href="/settings.aspx">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
