...
<%--                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention">--%>
                       ...
                       <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            <span class="menu-icon">
                                <svg class="svg.fill" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<%--                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-2 py-4 w-200px mh-75 overflow-auto">--%>
                    ...
                    <div class="ms-4 mt-4">
                        <!--begin:Menu link-->
                      <a class="black" href="/api_references.aspx">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="menu-title ms-2 fw-600">API</span>
                            <span class="menu-arrow"></span>
                        </span>
                     </a>
                        <!--end:Menu link-->
                    ...
                    <div class="ms-4 mt-5">
                       <a class="black" href="/cov.aspx">
                            ...
                            <span class="menu-link">
                                ...
                                <span class="menu-title ms-2 fw-600">Coverage</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                       </a>
                    ...
                    <!--begin:Menu item-->
                    <div class="ms-4 mt-5">
                        <a class="black" href="/settings.aspx">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <span class="menu-icon">
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="menu-title ms-2 fw-600">Settings</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <!--end:Menu link-->
                         </a>
