                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    ...
                                    <div class="row g-5 g-xl-10 mb-xl-10 mt-0">
                                        ...
                                        <div class="col-md-12 mb-md-0 mb-5 mt-5">
                                            <div class="card card-flush shadow-xs p-8 mb-5">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 mb-8 mb-md-0">
                                                            <div class="mb-8">
                                                                ...
                                                                <input type="text" class="form-control form-custom-input" name="date_from" id="date_from" runat="server" placeholder="Start date" required="" data-bs-toggle="tooltip" data-bs-placement="top" title="Report start date, only last 30 days are available..">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 mb-8 mb-md-0">
                                                            <div class="mb-8">
                                                                <label for="date_to" class="form-label fs-14 dark-color">End date</label>
                                                                <input type="text" class="form-control form-custom-input" name="date_to" id="date_to" runat="server" placeholder="Finish date" required="" max="2023-09-20" data-bs-toggle="tooltip" data-bs-placement="top" title="Report end date, only last 30 days are available..">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 mb-8 mb-md-0">
